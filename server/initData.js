  ...
  `,
    ...
    },
    {
      ...
      <ul>
          ...
          <li>
              <strong>Autonomy of Thought:</strong> Our AI moderators do not evaluate truthfulness because we believe it is the right of the individual to <strong>determine truth for themselves</strong>. We trust our users to engage with information responsibly and make informed judgments based on their own reasoning, rather than the reasoning of board rooms, bureaucrats, moderators, policy directors and the like. <strong>We uphold the autonomy of thought.</strong> Our role is not to shield or direct, but to provide a platform for unrestricted information sharing, to the maximum extent of the law and within the confines of our content policy. This approach ensures that every member of our community can contribute to and benefit from a truly open dialogue, fostering a richer, more nuanced understanding of the world.
          </li>
          <li>
